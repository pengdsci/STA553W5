...
(function ($) {
  ...
  $.flexslider = function(el, options) {
    ...
    methods = {
      ...
      directionNav: {
        setup: function() {
          var directionNavScaffold = $('<ul class="' + namespace + 'direction-nav"><li><a class="' + namespace + 'prev" href="#"><span class="a-l"></span><span class="a-r"></span></a></li><li><a class="' + namespace + 'next" href="#"><span class="a-l"></span><span class="a-r"></span></a></li></ul>');
